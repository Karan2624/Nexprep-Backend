...
import { getCodeforcesStat, linkCodeforcesHandle, syncCodeforcesStat } from "../controllers/codeforcesStat.controller.js";
...
router.route("/me").get(verifyJWT, getCodeforcesStat);
